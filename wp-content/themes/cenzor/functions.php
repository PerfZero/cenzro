...
function cenzor_generate_pricing_for_profession_591() {
	$profession_id = 591;
	...
	$pricing_data = array(
		...
		array(
			'program' => '46 б - «Обучение безопасным методам и приемам выполнения работ при воздействии вредных и (или) опасных производственных факторов, опасностей, источников опасностей, идентифицированных в рамках системы управления охраной труда в организации и оценки профессиональных рисков»',
			'hours' => '20',
			'price' => '750,00',
		),
		array(
			'program' => '46В_1 - Безопасные методы приемы выполнения земляных работ.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_2 – Безопасные методы и приемы выполнения ремонтных, монтажных и демонтажных работ зданий и сооружений.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_3 – Безопасные методы и приемы выполнения работ при размещении, монтаже, техническом обслуживании и ремонте технологического оборудования (включая технологическое оборудование)',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_4 – Безопасные методы и приемы выполнения работ на высоте.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_5 – Безопасные методы и приемы выполнения пожароопасных работ.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_6 - Безопасные методы и приемы выполнения работ в ограниченных и замкнутых пространствах',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_7 - Безопасные методы и приемы выполнения строительных работ, в том числе: - окрасочные работы - электросварочные и газосварочные работы.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_8 - Безопасные методы и приемы выполнения работ, связанные с опасностью воздействия сильнодействующих и ядовитых веществ.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_9 - Безопасные методы и приемы выполнения работ повышенной опасности газоопасных работ.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_10 - Безопасные методы и приемы выполнения работ повышенной опасности, огневых работ',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_11 - Безопасные методы и приемы выполнения работ повышенной опасности, связанных с эксплуатацией подъемных сооружений.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_12 – Безопасные методы и приемы выполнения работ, связанные с эксплуатацией тепловых энергоустановок.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_13 - Безопасные методы и приемы выполнения работ в электроустановках.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_14 - Безопасные методы и приемы выполнения строительных работ, связанные с эксплуатацией сосудов, работающих под избыточным давлением.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_18 - Безопасные методы и приемы выполнения работ повышенной опасности в непосредственной близости от полотна или проезжей части эксплуатируемых автомобильных и железных дорог.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_19 – Безопасные методы и приемы работ, на участках с патогенным заражение почвы.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_20 – Безопасные методы и приемы работ по валке леса в особо опасных условия.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_21 – Безопасные методы и приемы работ по перемещению тяжеловесных и крупногабаритных грузов при отсутствии машин соответствующей грузоподъемности и разборке покосившихся и опасных (неправильно уложенных) штабелей круглых лесоматериалов.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_22 - Безопасные методы и приемы выполнения работ с радиоактивными веществами и источниками ионизирующих излучений.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
			'program' => '46В_23 - Безопасные методы и приемы работ с ручным инструментом, в т.ч. пиротехническим.',
			'hours' => '16',
			'price' => '550,00',
		),
		array(
...
function cenzor_pricing_generator_admin_page_callback() {
	if ( isset( $_GET['generate'] ) && $_GET['generate'] === '591' && current_user_can( 'manage_options' ) ) {
		$result = cenzor_generate_pricing_for_profession_591();
		wp_die(
			'<div style="padding: 20px; font-family: Arial, sans-serif;">
				<h1>' . ( $result['success'] ? '✓ Успешно!' : '✗ Ошибка!' ) . '</h1>
				<p>' . esc_html( $result['message'] ) . '</p>
				<p><a href="' . admin_url( 'edit.php?post_type=profession&page=generate-pricing-591' ) . '">Вернуться назад</a></p>
			</div>',
	...
	?>
	<div class="wrap">
		<h1>Генерация прайса для профессии ID 591</h1>
		<p>Эта функция сгенерирует прайс для профессии с ID 591.</p>
		<p>Вы также можете использовать прямую ссылку: <a href="<?php echo admin_url( 'edit.php?post_type=profession&page=generate-pricing-591&generate=591' ); ?>"><?php echo admin_url( 'edit.php?post_type=profession&page=generate-pricing-591&generate=591' ); ?></a></p>
		<form method="post" action="">
			<?php wp_nonce_field( 'generate_pricing_action' ); ?>
			<p>
				<input type="submit" name="generate_pricing" class="button button-primary" value="Сгенерировать прайс" onclick="return confirm('Вы уверены, что хотите сгенерировать прайс для профессии ID 591? Существующий прайс будет перезаписан.');">
			</p>
		</form>
	</div>
	<?php
