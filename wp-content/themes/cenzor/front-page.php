...
<div class="promo-banner">
		<div class="container promo-container">
			<p class="promo-text">Курсы повышения квалификации ДПО и профессиональной переподготовки</p>
		</div>
	</div>	
	...
	<div class="container">
		...
		<div class="advantages-grid">
			...
			<div class="advantage-item">
				...
				<p class="advantage-description">Используем современные образовательные платформы и методики для эффективного обучения.</p>
			</div>
			<div class="advantage-item advantage-empty"></div>
			<div class="advantage-item">
				<div class="advantage-icon">
...
чем другие учебные центры.
			...
			<div class="benefits-grid">
				...
				<div class="benefit-item">
					...
					<div class="benefit-caption">
						<div class="benefit-title">Очно</div>
					</div>
				</div>
				<div class="benefit-item">
					<div class="benefit-icon">
...
<section class="courses-info-section">
	<div class="container">
		<article class="courses-article">
			<header>
				<h1 class="courses-main-title">Что важно знать о курсах повышения квалификации</h1>
			</header>
			<p class="courses-text">
				Самое главное – авторитетность компании, предлагающей обучение. Не нарваться на мошенников просто – проверяйте наличие соответствующей лицензии. <strong>Учебный центр «Цензор»</strong> официально аккредитован проводить курсы повышения квалификации по широкому спектру профессий. А значит обладает всеми необходимыми учебными материалами и квалифицированными педагогами. Ведет контроль прохождения практики, проверку тестовых заданий, по результату выдает официальное удостоверение государственного образца.
			</p>
			<h2 class="courses-subtitle">Выгоды режима обучения.</h2>
			<p class="courses-text">
				Прохождение курсов эффективно и экономит время.</p>
			<h3 class="courses-h3">Преимущества прохождения курсов</h3>
			<ul class="courses-list">
				...
				<li>Все делает в личном кабинете на сайте и электронно.</li>
				<li>Формы тестирования с проверкой нейросетей.</li>
				<li>Проходить образовательные программы и тесты неограниченное количество раз. Доступ в личный кабинет сохраняется.</li>
				<li>Бесплатная отправка по почте дипломов и документов о повышении квалификации.</li>
				<li>Прохождение курсов ничем не уступает офлайн обучению.</li>
			...
			<p class="courses-text">
				Лицензия учебного центра «Цензора» гарантирует Вам, что все полученные знания будут достаточными для успешной работы на новом или необходимом уровне квалификации. Выдаваемое удостоверение государственного образца подтверждает его, позволяет пройти все проверки и аттестации. Профессиональный рост в ряде профессий состоит из нескольких этапов, позволяя сначала получить удостоверение ответственного специалиста, а в будущем вырасти до руководителя подразделения, вплоть до главы предприятия. Качество полученного образования в учебном центре «Цензор» гарантирует старт карьеры. Курсы выдаются в несколько этапов в зависимости от выбранной профессии. Каждый образовательная программа завершается тестами и экзаменационной работой. Формула прохождения обучения позволяет одновременно нарабатывать практический опыт на месте работы.
			</p>
