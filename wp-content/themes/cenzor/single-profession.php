    ...
    <div class="profession-result-text">Достижение профессиональных целей и карьерный рост</div>
		...
		if ( $pricing && is_array( $pricing ) ) : ?>
			<section id="profession-pricing" class="profession-content-section">
				<div class="container">
					<h2 class="profession-section-title">Стоимость обучения на все программы по <?php the_title(); ?></h2>
		...
		<section id="profession-steps" class="profession-content-section">
			<div class="container">
				<h2 class="profession-section-title">4 ШАГА ДЛЯ ОБУЧЕНИЯ ПО <?php the_title(); ?></h2>
